...
export default function TopNavigationBar(props: Props) {
	...
	return (
		<div>
			<HideOnScroll {...props}>
				<nav className="fixed inset-x-0 top-0 z-50 w-full border-none shadow-sm backdrop-blur-md backdrop-saturate-150 h-12 md:h-14 lg:h-16">
					<div className="relative flex h-full items-center">
						...
						<div className="flex w-full md:hidden items-center justify-between p-2">
							<div>
								<img
									src="/bochi-avatar.jpg"
									alt="bochi"
									className="w-8 h-8 rounded-full border-primary border-2"
								/>
							</div>
							...
							<div className="flex flex-row gap-4">
								<Button
									type="button"
									onClick={() => setIsSearchOpen(true)}
									className="flex size-8 items-center justify-center rounded-full active:bg-primary/20 active:scale-95 transition-all"
								>
									<MagnifyingGlassIcon className="text-primary" />
								</Button>
								<Button
